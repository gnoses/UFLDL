...
pooledFeatures = cnnPoolLarge(poolDim, convolvedFeatures);
...
% save binary 
pooledFeaturesCat = permute(pooledFeatures, [1 3 4 2]);
% pooledFeaturesCat = reshape(pooledFeaturesCat, numel(pooledFeaturesCat), 1);
writeMat(pooledFeaturesCat);
